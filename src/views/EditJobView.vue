...
onMounted(async () => {
  try {
    ...
    formData.company.name = data.company.name;
    formData.company.description = data.company.description;
    formData.company.contactEmail = data.company.contactEmail;
    formData.company.contactPhone = data.company.contactPhone;
  } catch (error) {
...
const handleEditJob = async () => {
  ...
  try {
    ...
    console.log("Error addin new job " + error.message);
  }
};
</script>
      ...
      >
        <form @submit.prevent="handleEditJob">
          <h2 class="text-3xl text-center font-semibold mb-6">
            Edit form another_test branch Job
          </h2>
